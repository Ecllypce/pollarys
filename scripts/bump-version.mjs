...
if (fs.existsSync(cargoLockPath)) {
  try {
    ...
    if (anchorIndex !== -1) {
      ...
      console.warn(`Warning: could not find pollarys-desktop entry in ${CARGO_LOCK}`);
    }
  } catch (e) {
