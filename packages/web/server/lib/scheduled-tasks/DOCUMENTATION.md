...
Server-owned scheduled task runtime and routes for Pollarys-only automation.
...
- This module is Pollarys feature logic; it is intentionally separate from OpenCode proxy/runtime internals.
...
- Registers:
  ...
  - `GET /api/pollarys/scheduled-tasks/status`
  - `GET /api/pollarys/events`
