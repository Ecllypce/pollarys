...
Download from [Releases](https://github.com/btriapitsyn/pollarys/releases). Available for macOS (Apple Silicon and Intel).

> **Prerequisite:** [OpenCode CLI](https://opencode.ai) installed.

## What makes the desktop app special

- **Remote instances over SSH** - connect to remote Pollarys servers with dedicated lifecycle and UX flows
...
- **Local + remote switching** - jump between local and remote Pollarys instances
- **Native macOS integration** - menus, deep-links, auto-update, and polished window management

Plus everything from the shared Pollarys UI: branchable timeline, Git sidebar, terminal, voice mode, and more.
...
- Configure in **Settings -> Pollarys -> Remote Tunnel**.
