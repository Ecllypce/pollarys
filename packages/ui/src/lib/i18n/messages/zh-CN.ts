...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Pollarys 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Pollarys 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutPollarys': '关于 Pollarys',
  ...
  'header.services.shutdownDev': '停止 Pollarys',
  ...
  'aboutDialog.PollarysVersionLabel': 'Pollarys 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Pollarys 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Pollarys',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Pollarys',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Pollarys 服务器之间切换',
  ...
  'multiRun.window.description': 'Pollarys 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Pollarys',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Pollarys 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Pollarys 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Pollarys 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Pollarys 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Pollarys 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Pollarys。请确认地址是否指向 Pollarys 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Pollarys。请确认地址是否指向 Pollarys 服务器。',
  ...
  'startup.initRecovery.description': 'Pollarys 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 Pollarys...',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：pollarys update',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Pollarys 打开。',
  ...
  'PollarysLogo.aria.logo': 'Pollarys 标志',
