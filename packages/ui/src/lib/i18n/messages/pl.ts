...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Pollarys, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Pollarys został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutPollarys': 'O Pollarys',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Pollarys.',
  ...
  'onboarding.chooser.title': 'Witaj w Pollarys',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Pollarys nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Pollarys i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Pollarys aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Pollarys, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Pollarys. Zweryfikuj czy adres wskazuje na serwer Pollarys.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Pollarys. Zweryfikuj czy adres wskazuje na serwer Pollarys.',
  ...
  'startup.initRecovery.description': 'Pollarys nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Pollarys, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.PollarysVersionLabel': 'Wersja Pollarys {version}',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Pollarys',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Pollarys',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Pollarys.',
  ...
  'PollarysLogo.aria.logo': 'Logo Pollarys',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Pollarys',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: pollarys update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Pollarys...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Pollarys otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Pollarys — zainstaluj je, aby zacząć.',
  ...
  'settings.pollarys.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  'settings.pollarys.visual.field.mobileKeyboardMode': 'Tryb klawiatury mobilnej',
  'settings.pollarys.visual.field.mobileKeyboardModeHint': 'Wybierz sposób zachowania widoku podczas otwartej klawiatury.',
  'settings.pollarys.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.pollarys.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.pollarys.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.pollarys.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.pollarys.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.pollarys.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.pollarys.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
