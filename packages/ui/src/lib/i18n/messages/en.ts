...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Pollarys for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Pollarys installed',
  ...
  'sessions.sidebar.footer.actions.aboutPollarys': 'About Pollarys',
  ...
  'header.services.shutdownDev': 'Stop Pollarys',
  ...
  'aboutDialog.PollarysVersionLabel': 'Pollarys version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Pollarys state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Pollarys efficiently',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Pollarys',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Pollarys servers',
  ...
  'multiRun.window.description': 'Pollarys Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Pollarys',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Pollarys does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Pollarys — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Pollarys settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Pollarys server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Pollarys server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Pollarys. Verify the address points to an Pollarys server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Pollarys. Verify the address points to an Pollarys server.',
  ...
  'startup.initRecovery.description': 'Pollarys could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Pollarys...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: pollarys update',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Pollarys open.',
  ...
  'PollarysLogo.aria.logo': 'Pollarys logo',
