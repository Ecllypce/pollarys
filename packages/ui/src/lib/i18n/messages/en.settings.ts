export const settingsDict = {
  ...
  'settings.window.description': 'Pollarys settings window.',
  ...
  'settings.pollarys.tunnel.title': 'Remote Tunnel',
  'settings.pollarys.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.pollarys.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.pollarys.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.pollarys.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.pollarys.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.pollarys.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.pollarys.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.pollarys.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.pollarys.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.pollarys.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.pollarys.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.pollarys.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.pollarys.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.pollarys.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.pollarys.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.pollarys.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.pollarys.tunnel.field.provider': 'Provider',
  'settings.pollarys.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.pollarys.tunnel.field.tunnelType': 'Tunnel type',
  'settings.pollarys.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.pollarys.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.pollarys.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.pollarys.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.pollarys.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.pollarys.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.pollarys.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.pollarys.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.pollarys.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.pollarys.tunnel.field.configurationFile': 'Configuration file',
  'settings.pollarys.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.pollarys.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.pollarys.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.pollarys.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.pollarys.tunnel.field.connectLink': 'Connect link',
  'settings.pollarys.tunnel.field.expires': 'Expires',
  'settings.pollarys.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.pollarys.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.pollarys.tunnel.actions.saveToken': 'Save token',
  'settings.pollarys.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.pollarys.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.pollarys.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.pollarys.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.pollarys.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.pollarys.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.pollarys.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.pollarys.tunnel.actions.stopping': 'Stopping...',
  'settings.pollarys.tunnel.actions.newConnectLink': 'New connect link',
  'settings.pollarys.tunnel.actions.copied': 'Copied',
  'settings.pollarys.tunnel.actions.retry': 'Retry',
  'settings.pollarys.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.pollarys.tunnel.option.mode.quick.label': 'Quick',
  'settings.pollarys.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and Cloudflare does not guarantee uptime.',
  'settings.pollarys.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.pollarys.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.pollarys.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.pollarys.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.pollarys.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.pollarys.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.pollarys.tunnel.state.loading': 'Loading',
  'settings.pollarys.tunnel.state.expired': 'Expired',
  'settings.pollarys.tunnel.state.revoked': 'Revoked',
  'settings.pollarys.tunnel.state.inactive': 'Inactive',
  'settings.pollarys.tunnel.state.noExpiry': 'No expiry',
  'settings.pollarys.tunnel.state.never': 'Never',
  'settings.pollarys.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.pollarys.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.pollarys.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.pollarys.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.pollarys.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.pollarys.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/pollarys/cloudflare-managed-remote-tunnels.json.',
  'settings.pollarys.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.pollarys.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.pollarys.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.pollarys.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.pollarys.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.pollarys.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.pollarys.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.pollarys.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.pollarys.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.pollarys.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.pollarys.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.pollarys.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.pollarys.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.pollarys.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.pollarys.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.pollarys.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.pollarys.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.pollarys.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.pollarys.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.pollarys.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.pollarys.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.pollarys.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.pollarys.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.pollarys.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.pollarys.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.pollarys.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed installs/updates and starts Pollarys remotely. External assumes it is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port Pollarys should use on the remote host. Leave empty to let the runtime choose.',
  'settings.remoteInstances.page.field.keepServerRunning': 'Keep server running',
  'settings.remoteInstances.page.field.keepServerRunningHint': 'If enabled, Pollarys daemon is left running remotely when you disconnect.',
  ...
  'settings.remoteInstances.page.field.preferredLocalPortHint': 'Preferred local port for the main Pollarys tunnel. Leave empty for auto-select.',
  ...
  'settings.pollarys.about.title': 'About Pollarys',
  'settings.pollarys.about.field.version': 'Version',
  'settings.pollarys.about.state.checking': 'Checking...',
  'settings.pollarys.about.state.upToDate': 'Up to date',
  'settings.pollarys.about.actions.checkUpdates': 'Check updates',
  'settings.pollarys.about.actions.update': 'Update',
  'settings.pollarys.about.actions.updateToVersion': 'Update to {version}',
  'settings.pollarys.about.actions.checkForUpdates': 'Check for updates',
  'settings.pollarys.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Pollarys will scan it for folders containing',
  ...
  'settings.pollarys.passkeys.title': 'Passkeys',
  'settings.pollarys.passkeys.field.currentDevice': 'Current device',
  'settings.pollarys.passkeys.actions.add': 'Add passkey',
  'settings.pollarys.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.pollarys.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.pollarys.passkeys.actions.signingOut': 'Signing out…',
  'settings.pollarys.passkeys.actions.removing': 'Removing…',
  'settings.pollarys.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.pollarys.passkeys.state.loading': 'Loading passkeys…',
  'settings.pollarys.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.pollarys.passkeys.item.lastUsed': 'Last used {time}',
  'settings.pollarys.passkeys.item.added': 'Added {time}',
  'settings.pollarys.passkeys.time.neverUsed': 'Never used',
  'settings.pollarys.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.pollarys.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.pollarys.passkeys.toast.added': 'Passkey added',
  'settings.pollarys.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.pollarys.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.pollarys.passkeys.toast.removed': 'Passkey removed',
  'settings.pollarys.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.pollarys.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.pollarys.sessionRetention.title': 'Session Retention',
  'settings.pollarys.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.pollarys.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.pollarys.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.pollarys.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.pollarys.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.pollarys.sessionRetention.field.days': 'days',
  'settings.pollarys.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.pollarys.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.pollarys.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.pollarys.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.pollarys.sessionRetention.action.archive': 'Archive',
  'settings.pollarys.sessionRetention.action.delete': 'Delete',
  'settings.pollarys.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.pollarys.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.pollarys.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.pollarys.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.pollarys.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.pollarys.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.pollarys.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.pollarys.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.pollarys.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.pollarys.desktopNetwork.title': 'Desktop Network Access',
  'settings.pollarys.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.pollarys.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.pollarys.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.pollarys.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.pollarys.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.pollarys.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.pollarys.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.pollarys.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.pollarys.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.pollarys.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.pollarys.opencodeCli.title': 'OpenCode CLI',
  'settings.pollarys.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.pollarys.opencodeCli.tooltipSuffix': 'binary.',
  'settings.pollarys.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.pollarys.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.pollarys.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.pollarys.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.pollarys.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.pollarys.opencodeCli.actions.browse': 'Browse',
  'settings.pollarys.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.pollarys.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.pollarys.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.pollarys.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.pollarys.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.pollarys.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.pollarys.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.pollarys.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.pollarys.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.pollarys.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.pollarys.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.pollarys.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.pollarys.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.pollarys.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.pollarys.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.pollarys.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.pollarys.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.pollarys.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.pollarys.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.pollarys.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.pollarys.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.pollarys.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.pollarys.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.pollarys.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.pollarys.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.pollarys.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.pollarys.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.pollarys.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.pollarys.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.pollarys.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.pollarys.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.pollarys.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.pollarys.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.pollarys.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.pollarys.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.pollarys.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.pollarys.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'How Pollarys is managed and started on the remote host.',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Pollarys UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Pollarys is installed when running in managed mode.',
  ...
  'settings.remoteInstances.page.phase.installingPollarys': 'Installing Pollarys',
  'settings.remoteInstances.page.phase.updatingPollarys': 'Updating Pollarys',
  ...
  'settings.pollarys.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.pollarys.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.pollarys.worktrees.setup.title': 'Setup commands',
  'settings.pollarys.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.pollarys.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.pollarys.worktrees.setup.loading': 'Loading...',
  'settings.pollarys.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.pollarys.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.pollarys.worktrees.setup.addCommand': 'Add command',
  'settings.pollarys.worktrees.list.title': 'Existing worktrees',
  'settings.pollarys.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.pollarys.worktrees.list.loading': 'Loading worktrees...',
  'settings.pollarys.worktrees.list.empty': 'No worktrees found for this project',
  'settings.pollarys.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.pollarys.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Pollarys.',
  ...
  'settings.pollarys.defaults.title': 'Session Defaults',
  'settings.pollarys.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.pollarys.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.pollarys.defaults.field.defaultModel': 'Default Model',
  'settings.pollarys.defaults.field.defaultThinking': 'Default Thinking',
  'settings.pollarys.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.pollarys.defaults.field.defaultAgent': 'Default Agent',
  'settings.pollarys.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.pollarys.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.pollarys.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.pollarys.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.pollarys.defaults.option.default': 'Default',
  'settings.pollarys.defaults.option.defaultLowercase': 'default',
  'settings.pollarys.git.title': 'Git Preferences',
  'settings.pollarys.git.changesViewTitle': 'Changes View',
  'settings.pollarys.git.changesViewAria': 'Git changes view mode',
  'settings.pollarys.git.option.flatList': 'Flat List',
  'settings.pollarys.git.option.treeView': 'Tree View',
  'settings.pollarys.git.optionAria': 'Git changes view mode: {option}',
  'settings.pollarys.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.pollarys.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.pollarys.git.showGitignoredAria': 'Display gitignored files',
  'settings.pollarys.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize Pollarys',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Pollarys.',
  ...
  'settings.pollarys.visual.section.colorMode': 'Color Mode',
  'settings.pollarys.visual.section.localization': 'Localization',
  'settings.pollarys.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.pollarys.visual.section.navigation': 'Navigation',
  'settings.pollarys.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.pollarys.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.pollarys.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.pollarys.visual.section.activityDefault': 'Activity Default',
  'settings.pollarys.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.pollarys.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.pollarys.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.pollarys.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.pollarys.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.pollarys.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.pollarys.visual.section.diffLayout': 'Diff Layout',
  'settings.pollarys.visual.section.diffLayoutAria': 'Diff layout',
  'settings.pollarys.visual.section.diffViewMode': 'Diff View Mode',
  'settings.pollarys.visual.section.diffViewModeAria': 'Diff view mode',
  'settings.pollarys.visual.section.privacy': 'Privacy',
  'settings.pollarys.visual.field.lightTheme': 'Light Theme',
  'settings.pollarys.visual.field.darkTheme': 'Dark Theme',
  'settings.pollarys.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.pollarys.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.pollarys.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.pollarys.visual.field.timeFormat': 'Time Format',
  'settings.pollarys.visual.field.weekStartsOn': 'Week Starts On',
  'settings.pollarys.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.pollarys.visual.field.selectWeekStartAria': 'Select week start',
  'settings.pollarys.visual.actions.reloadThemes': 'Reload themes',
  'settings.pollarys.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.pollarys.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.pollarys.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/pollarys/themes/',
  'settings.pollarys.visual.field.installAppName': 'Install App Name',
  'settings.pollarys.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.pollarys.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.pollarys.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.pollarys.visual.field.installOrientation': 'Install Orientation',
  'settings.pollarys.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.pollarys.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.pollarys.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.pollarys.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.pollarys.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.pollarys.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.pollarys.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.pollarys.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.pollarys.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.pollarys.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.pollarys.visual.field.interfaceFont': 'Interface Font',
  'settings.pollarys.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.pollarys.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.pollarys.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.pollarys.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.pollarys.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.pollarys.visual.field.codeFont': 'Code Font',
  'settings.pollarys.visual.field.selectCodeFontAria': 'Select code font',
  'settings.pollarys.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.pollarys.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.pollarys.visual.field.spacingDensity': 'Spacing Density',
  'settings.pollarys.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.pollarys.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.pollarys.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.pollarys.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.pollarys.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.pollarys.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.pollarys.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.pollarys.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.pollarys.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.pollarys.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.pollarys.visual.field.bash': 'Bash',
  'settings.pollarys.visual.field.editTools': 'Edit tools',
  'settings.pollarys.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.pollarys.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.pollarys.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.pollarys.visual.field.diffViewModeAria': 'Diff view mode: {option}',
  'settings.pollarys.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.pollarys.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.pollarys.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.pollarys.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.pollarys.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.pollarys.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.pollarys.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.pollarys.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.pollarys.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.pollarys.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.pollarys.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.pollarys.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.pollarys.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.pollarys.visual.field.showMobileStatusBarAria': 'Show mobile status bar',
  'settings.pollarys.visual.field.showMobileStatusBar': 'Show Mobile Status Bar',
  'settings.pollarys.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.pollarys.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.pollarys.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.pollarys.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.pollarys.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.pollarys.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.pollarys.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.pollarys.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.pollarys.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.pollarys.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.pollarys.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.pollarys.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.pollarys.visual.option.themeMode.system': 'System',
  'settings.pollarys.visual.option.themeMode.light': 'Light',
  'settings.pollarys.visual.option.themeMode.dark': 'Dark',
  'settings.pollarys.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.pollarys.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.pollarys.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.pollarys.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.pollarys.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.pollarys.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.pollarys.visual.option.diffViewMode.single.label': 'Single file',
  'settings.pollarys.visual.option.diffViewMode.single.description': 'Show one file at a time.',
  'settings.pollarys.visual.option.diffViewMode.stacked.label': 'All files',
  'settings.pollarys.visual.option.diffViewMode.stacked.description': 'Stack all changed files together.',
  'settings.pollarys.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.pollarys.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.pollarys.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.pollarys.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.pollarys.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.pollarys.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.pollarys.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.pollarys.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.pollarys.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.pollarys.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.pollarys.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.pollarys.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.pollarys.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.pollarys.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.pollarys.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.pollarys.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.pollarys.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.pollarys.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'settings.pollarys.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.pollarys.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.pollarys.visual.option.chatRenderMode.live.label': 'Live',
  'settings.pollarys.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.pollarys.visual.option.messageTransport.auto.label': 'Auto',
  'settings.pollarys.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.pollarys.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.pollarys.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.pollarys.visual.option.messageTransport.sse.label': 'SSE',
  'settings.pollarys.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.pollarys.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.pollarys.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.pollarys.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.pollarys.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.pollarys.visual.option.timeFormat.auto.label': 'Auto',
  'settings.pollarys.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.pollarys.visual.option.timeFormat.24h.label': '24-hour',
  'settings.pollarys.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.pollarys.visual.option.timeFormat.12h.label': '12-hour',
  'settings.pollarys.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.pollarys.visual.option.weekStart.auto.label': 'Auto',
  'settings.pollarys.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.pollarys.visual.option.weekStart.monday.label': 'Monday',
  'settings.pollarys.visual.option.weekStart.sunday.label': 'Sunday',
