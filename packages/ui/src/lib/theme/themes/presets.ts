...
import Pollarys_dark_Raw from './fields-of-the-shire-dark.json';
import Pollarys_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  Pollarys_dark_Raw as Theme,
  Pollarys_light_Raw as Theme,
