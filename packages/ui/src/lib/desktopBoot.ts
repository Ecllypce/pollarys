 ...
 * it as `window.__POLLARYS_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __POLLARYS_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__POLLARYS_DESKTOP_BOOT_OUTCOME__;
