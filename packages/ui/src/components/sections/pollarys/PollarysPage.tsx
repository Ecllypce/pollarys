...
import { PollarysVisualSettings } from './PollarysVisualSettings';
...
import type { PollarysSection } from './types';

interface PollarysPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: PollarysSection;
}

export const PollarysPage: React.FC<PollarysPageProps> = ({ section }) => {
    ...
    if (!section) {
        return (
            <ScrollableOverlay
                ...
                className="w-full"
            >
                <div className="Pollarys-page-body mx-auto max-w-3xl space-y-3 p-3 sm:space-y-6 sm:p-6 sm:pt-8">
                    <PollarysVisualSettings />
    ...
    return (
        <ScrollableOverlay
            ...
            className="w-full"
        >
            <div className="Pollarys-page-body mx-auto max-w-3xl space-y-6 p-3 sm:p-6 sm:pt-8">
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <PollarysVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'pwaOrientation',
        'mobileKeyboardMode',
