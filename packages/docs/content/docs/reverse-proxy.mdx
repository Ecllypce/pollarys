---
title: Reverse Proxy
description: Configure Pollarys correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run Pollarys behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
